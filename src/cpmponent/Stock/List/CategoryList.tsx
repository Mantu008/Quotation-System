...
const sampleData: UnitData[] = [
    { srNo: 1, name: "Category A" },
    { srNo: 2, name: "Category B" },
    { srNo: 3, name: "Category C" },
    { srNo: 4, name: "Category D" },
    { srNo: 5, name: "Category E" },
];
...
const CategoryList: React.FC = () => {
    ...
    const handleAddData = () => {
        navigate("/stock/category"); // Navigate to the add unit page
    };
